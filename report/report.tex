...
\begin{equation}
E[\frac{1}{N} \sum_{i=1}^{N} f(X_i)], X \sim U = E[\frac{1}{N} \sum_{i=1}^{N} \frac{f(X_i)}{p(X_i)}], X \sim p \text{\footnote{TODO: I know this is not quite right, I need to find the proper equalitiy for expected values of different distributions.}}
\end{equation}
